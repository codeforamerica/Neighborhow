...
// NEIGHBORHOW MOD -
// Moved count to the far right
		$ret = $this->get_code('vote_up', false, $blog_id, $post_id) . ' ' . $this->get_code('vote_down', false, $blog_id, $post_id) . ' ' . $this->get_code('vote_result', false, $blog_id, $post_id);
