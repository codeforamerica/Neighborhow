...
<div id="sidebar-nh" class="sidebar-nh">
	<div class="widget-side">
		...
		<div class="recent-fdbk">
			<p style="margin:.85em 0 1.5em 0;text-align:right;"><a id="addfdbk" rel="tooltip" data-placement="bottom" class="nh-btn-blue" href="<?php echo $app_url;?>/add-idea" data-title="You'll need to sign in--or sign up--before you can add your idea." title="You'll need to sign in--or sign up--before you can add your idea.">Add Your Idea</a></p>
			<ul>
<?php
...
?>								
	...
	<div class="widget-side">
		...
		<div class="widget-copy">
			<ul class="bullets">
				<li class="bullets"><a class="nhline" href="<?php echo $app_url;?>/submitstory" title="Share your story">Share Your Story</a> &#8212; We&#39;ll feature stories about how you&#39;ve improved your neighborhood.</li>
				
				<li class="bullets"><a class="nhline" href="<?php echo $app_url;?>/submitstory" title="Share your story">Join the conversation</a> &#8212; Help us decide what content and features to include.</li>
				
				<li class="bullets"><a class="nhline" href="<?php echo $app_url;?>/submitstory" title="Share your story">Contact us</a> &#8212; If you&#39;re a city or organization who wants Neighborhow in your city.</li>												
			</ul>
		</div>
	</div><!--/ widget-->
