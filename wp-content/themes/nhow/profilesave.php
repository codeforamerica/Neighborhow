...
<h3 class="page-title">Edit Your Profile Settings</h3>
...
<?php 
// only admin sees editor, color scheme, shortcuts, + toolbar options
?>
...
<?php do_action( 'profile_personal_options', $profileuser ); ?>
	...
	<div class="profile-details" style="border:1px solid red;width:45%;float;left;">
	<!--h4><?php _e( 'Name', 'theme-my-login' ) ?></h4-->
...
?>
	...
	<div class="profile-about" style="border:1px solid red;width:35%;float;left;">
