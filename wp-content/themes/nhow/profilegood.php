...
<?php do_action( 'profile_personal_options', $profileuser ); ?>	
			...
			<div class="form-item">
				...
				<span class="help-block <?php foreach ($nh_error_keys as $key) { if ($key == "empty_first_name" OR $key == "invalid_first_name" OR $key == "maxlength_first_name") { echo 'nh-error'; }} ?>">First and last name are publicly visible. Max length for first name is 16 characters.</span>
			</div>
			...
			<div class="form-item">
				...
				<span class="help-block <?php foreach ($nh_error_keys as $key) { if ($key == "empty_last_name" OR $key == "invalid_last_name" OR $key == "maxlength_last_name") { echo 'nh-error'; }} ?>">First and last name are publicly visible. Max length for last name is 30 characters.</span>
			</div>
