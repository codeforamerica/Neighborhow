...
?>
			<div class="single-guide-img overview">
				<div class="carousel-inner"><img src="<?php echo $style_url;?>/lib/timthumb.php?src=<?php echo $img_feature_src[0];?>&w=400&h=280&q=95&zc=2&a=t" alt="Photo of <?php the_title();?>" />
