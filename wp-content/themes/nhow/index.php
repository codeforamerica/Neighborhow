...
if(count($sticky_ids) != 0) {
	...
	while ($sticky_query->have_posts()) : $sticky_query->the_post();
		...
		echo '<img  src="'.$style_url.'/lib/timthumb.php?src='.$imgSrc[0].'&w=184&h=115&zc=1&a=tl" alt="Photo from '.get_the_title().'" />';
...
wp_reset_query();	
	...
	while ($normal_query->have_posts()) : $normal_query->the_post();
		...
		echo '<img class="guide_image_bg" src="'.$style_url.'/lib/timthumb.php?src='.$imgSrc[0].'&w=184&h=115&zc=1&a=tl" alt="Photo from '.get_the_title().'" /></a>';
