...
<div id="page-profile">
	<p class="backto"><a href="" title="">&#60; back to Your Profile</a>
	</p>
	<h3 class="page-title">Edit Your Profile Settings</h3>
</div>

<div style="" class="login profile" id="theme-my-login<?php $template->the_instance(); ?>">
...
<?php wp_nonce_field( 'update-user_' . $current_user->ID ) ?>
	...
	<div class="form-container" style="border:1px solid #ddd;padding:1em;">
