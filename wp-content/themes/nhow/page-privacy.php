	...
	<div class="wrapper">
		<div id="main">
			<div id="content" class="about">
				...
				<p>If you have any questions or comments about this Privacy Policy, please contact us at <a href="mailto:information@neighborhow.org">information@neighborhow.org</a></p>
				...
				<p><strong>Privacy Policy Changes</strong> We may revise this Privacy Policy from time to time. The most current version will always be at <a href="<?php echo $app_url;?>/privacy" title="View privacy policy">http://neighborhow.org/privacy</a>. If we make any changes to this policy, we will provide notice on this page and to all registered users. By continuing to access or use the Services after those changes become effective, you agree to the terms of the revised Privacy Policy.</p>
